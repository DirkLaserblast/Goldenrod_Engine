...
void display()
{
    ...
    glBindBuffer(GL_ARRAY_BUFFER, shader->vertexBuffer); //which buffer we want to use
    glBufferData(
    ...
    glBindBuffer(GL_ARRAY_BUFFER, shader->normalBuffer); //which buffer we want to use
    glBufferData(
                GL_ARRAY_BUFFER, //what kind of buffer (an array)
